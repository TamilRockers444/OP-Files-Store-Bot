...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/TamilRockers444/OP-Files-Store-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/TamilRockers444/OP-Files-Store-Bot
cd File-Sharing-Bot
